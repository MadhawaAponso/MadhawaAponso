...
![Verilog](https://img.shields.io/badge/Verilog-000000?style=for-the-badge&logo=&logoColor=white)

#### 💡 Technical Skills
`Web Development` · `Backend Development` · `Microservices`  
`Machine Learning` · `NLP` · `Large Language Models (LLMs)` · `Game Development`
...
![SpikingJelly](https://img.shields.io/badge/SpikingJelly-orange?style=for-the-badge)
